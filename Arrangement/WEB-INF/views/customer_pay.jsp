  ...
  <nav class="navbar navbar-default navbar-static-top" role="navigation"
	...
	<!-- 左侧显示列表部分 end--> 
     ...
     <div align="center">
		...
		<br/>
		<div align="center">
		<img alt="weixin" src="${pageContext.request.contextPath }/images/weixinpay.png" width="284px" heigth="479"/>&nbsp;&nbsp;&nbsp;&nbsp;
		<img alt="alipay" src="${pageContext.request.contextPath }/images/alipay.png" width="284px" heigth="479"/>
        </div>
 </div>
